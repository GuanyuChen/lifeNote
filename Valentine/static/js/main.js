$(() => {
    ...
    function startLOVEWord() {
        ...
        $('.loving-word').typeIt({
            whatToType: ["大宝", 
                        "这是和你一起度过的第一个情人节，虽然远隔万里，但还是很有意义。",
                        "回头看来，我们的相遇其实很戏剧",
                        "谁能想到，在一个加班的晚上，我会遇到一个这么可爱的，想和她一起经历一生的姑娘",
                        "其实喜欢是什么 这个问题很难说清，聪明如我也很难说明白",
                        "当我发现我的心情完全受你控制之后，我知道这辈子我完了",
                        "我发现我想每天都看见你，我想跟你分享所有的新鲜事，我想让你永远开心，我想和你一起经历所有事情，我想每天和你一起醒来",
                        "我想要你",
                        "我知道我不是一个特别称职的男朋友，但请你相信，我会努力改掉我身上所有的缺点",
                        "我会等你回来",
                        "我想让你陪我走完这一生",
                        "我爱你"],
            typeSpeed: 100
